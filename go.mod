...
require (
	...
	k3sm.io/darwin-net v0.0.0-00010101000000-000000000000
	k3sm.io/runtimed v0.0.0-00010101000000-000000000000
	k8s.io/api v0.35.0
...
replace k3sm.io/runtimed => ../runtimed

replace k3sm.io/darwin-net => ../darwin-net
