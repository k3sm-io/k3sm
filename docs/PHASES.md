  ...
  - id: M3
    ...
    subphases:
      ...
      - id: M3.3
        ...
        acceptance:
          - id: M3.3-a1
            met: true  # 2026-09-01: hack/lab/m3.sh FULL GREEN on the two-Mac rig (MikoStudio server + MikoBook worker, both on main @eee0fb3 with the kubelet serving-cert fix): TestM3_InPodKubectlAndDNSOnWorker PASS — a pod on the joined worker resolves kubernetes.default.svc through the in-pod DNS shim and completes an authenticated apiserver call; TestM3_NodePort and TestM3_PVCPersistsAcrossRestart PASS in the same run (M3: 3 passed, 0 failed). Log: hack/lab/runs/m3-lab-twomac-2026-09-01.log.
