...
5. [What runs](what-runs.md) — the OCI images k3sm runs, what it refuses, and the path from a
...
8. [Versions](versions.md) — the Kubernetes version k3sm tracks and how to read the live pin.
9. [Upgrade](upgrade.md) — upgrading a node or cluster, the launchd restart model.
10. [Certificates](certificates.md) — the two CAs, `k3sm certificate rotate`, and what it does not do.
11. [Backup & restore](backup-restore.md) — the kine/SQLite datastore: `k3sm snapshot save`/`restore`,
...
16. [Limitations](limitations.md) — **the real gaps** — read this before you rely on k3sm.
